...
namespace Xamagon.SeedApp.Data.Logging
{
    public class Logger : ILogger
    {
        ...
        public void Exception(Exception exception, string[] tags = null, [CallerMemberName] string callerName = null, string callerFullTypeName = null)
        {
            ...
            foreach (var provider in _providers)
            {
                ...
                var data = new
                {
                    ...
                    ExceptionInnerException = exception.InnerException != null ? exception.InnerException.Message : "",
