...
namespace Xamagon.SeedApp.Common.Utilities
{
    public class RandomTextGenerator
    {
        ...
        {
            return GenerateRandomString(RandomStringMode.AlphaLowerCase, 10, 15) + "@" + GenerateRandomString(RandomStringMode.AlphaLowerCase, 10, 15) + ".com";
        }
    }
